...
public class ProductManager implements ProductService {
	...
	@Override
	public DataResult<List<Product>> getByCategoryCategoryId(int categoryId) {
		
		return new SuccessDataResult<List<Product>>(this.productDao.getByCategoryCategoryId(categoryId),"başarılı");
	}
